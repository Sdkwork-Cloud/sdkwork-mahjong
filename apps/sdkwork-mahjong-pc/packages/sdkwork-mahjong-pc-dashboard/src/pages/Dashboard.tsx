...
import { MatchmakingModal, CreateRoomModal } from "sdkwork-mahjong-pc-commons";
...
export default function Dashboard({ setCurrentView }: DashboardProps) {
  ...
  const rankingsData: Record<string, any[]> = {
    daily: [
      ...
      { rank: 3, name: "夜猫子", type: "Human", score: 1025, trend: "down" },
      { rank: 4, name: "算力节点_01", type: "AI", score: 960, trend: "up" },
      { rank: 5, name: "雀神附体", type: "Human", score: 945, trend: "up" },
    ...
    season: [
      ...
      { rank: 6, name: "四川麻将将", type: "Human", score: 9200, trend: "down" },
    ...
    allTime: [
      ...
      { rank: 2, name: "人类_李世石", type: "Human", score: 88500, trend: "up" },
      { rank: 3, name: "Pluribus", type: "AI", score: 85200, trend: "down" },
      { rank: 4, name: "棋圣_聂卫平", type: "Human", score: 82100, trend: "up" },
      { rank: 5, name: "DeepBlue", type: "AI", score: 79000, trend: "up" },
      { rank: 6, name: "雀神", type: "Human", score: 75000, trend: "down" },
  ...
  const dailyMissions = [
    { id: 1, title: t('mission_1'), progress: 2, total: 3, reward: t('50_points'), icon: <Cpu size={16} />, completed: false },
    { id: 2, title: t('mission_2'), progress: 0, total: 1, reward: t('100_points'), icon: <Trophy size={16} />, completed: false },
