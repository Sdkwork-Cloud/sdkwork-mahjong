...
const QUESTIONS = [
  {
    ...
    options: ["生", "死", "既生又死", "不确定"],
    answer: 2,
  },
  {
    id: 2,
    text: "光速在真空中的速度大约是多少？",
    options: ["30万公里/秒", "3万公里/秒", "300万公里/秒", "3000公里/秒"],
    answer: 0,
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    text: "相对论的提出者是谁？",
    options: ["牛顿", "爱因斯坦", "霍金", "伽利略"],
    answer: 1,
  },
  {
    id: 5,
    text: "人类历史上第一个登上月球的人是谁？",
    options: ["加加林", "阿姆斯特朗", "奥尔德林", "科林斯"],
    answer: 1,
  },
  {
    id: 6,
  ...
  },
  {
    ...
    options: ["斜边的平方", "斜边的两倍", "面积的平方", "周长的平方"],
    answer: 0,
  },
  {
    id: 8,
    text: "被称为“万物之理”的物理学理论是？",
    options: ["经典力学", "量子力学", "弦理论", "相对论"],
    answer: 2,
  },
  {
    id: 9,
